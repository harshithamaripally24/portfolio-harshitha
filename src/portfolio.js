  ...
  experience: [
    {
      ...
      date: "2024 – Present",
      descBullets: [
        "Developed  software components using C# .NET, resolved frontend bugs and made enhancements in Angular JS" ,"Implemented weekly data control to categorize 80K+ records and data fixes to conduct data control cleanup",
        "Collaborating on the migration project from C# .NET to Java by engaging in design and use case discussions"
      ]
    },
    {
